import OrderTransactionService from "../service/orderTransaction.service.js";
import { successResponse, createdResponse } from "../../../utils/response.js";
import BaseError from "../../../base_classes/base-error.js";
import orderTransactionSchema from "../schema/orderTransaction.schema.js";
...
class OrderTransactionController {
    ...
    async update(req, res) {
        ...
        const updated = await OrderTransactionService.update(orderTransactionId, value);
