...
const productSchema = {
    ...
    //         field: Joi.string().valid('name', 'price', 'description', 'category', 'is_active','created_at', 'updated_at').required(),
    //         direction: Joi.string().valid('asc', 'desc').default('asc')
    //     }).optional(),

    //     include_relation : Joi.array().items(
    //         Joi.string().valid('Order_item', 'Add_on_group', 'Product_config', 'Product_discount')).optional(),
    //     }).optional(),
