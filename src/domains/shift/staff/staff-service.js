...
class StaffService {
  ...
  async findAll(userId, query) {
    ...
    const shiftMonth = query?.advSearch?.shift_month ? new Date(query.advSearch.shift_month) : null;
    const startOfMonth = shiftMonth ? new Date(shiftMonth.getFullYear(), shiftMonth.getMonth(), 1, 0, 0, 0) : null;
    const endOfMonth = shiftMonth ? new Date(shiftMonth.getFullYear(), shiftMonth.getMonth() + 1, 0, 23, 59, 59) : null;
